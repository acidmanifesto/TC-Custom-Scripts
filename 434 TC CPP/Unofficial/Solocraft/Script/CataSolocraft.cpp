...
public:
    ...
    void SetInitialWorldSettings()
    {
        ...
        dungeons =
        {
            ...
            //CATA Instances
            {938, sConfigMgr->GetIntDefault("Solocraft.EndTime.Level", 80) },                             // End Time
            {670, sConfigMgr->GetIntDefault("Solocraft.GrimBatol.Level", 78) },                           // Grim Batol
            {755, sConfigMgr->GetIntDefault("Solocraft.LostCityofTolvir.Level", 80) },                    // Lost City of Tolvir
            {576, sConfigMgr->GetIntDefault("Solocraft.TheNexus.Level", 80) },                            // TheNexus
        ...
        diff_Multiplier =
        {
            ...
            // CATA Instances
            {669, sConfigMgr->GetFloatDefault("Solocraft.BlackwingsDescentRaid", 10.0) },                  // Blackwings Descent
            {671, sConfigMgr->GetFloatDefault("Solocraft.BastionOfTwilightRaid", 10.0) },                  // The Bastion of Twilight
            {720, sConfigMgr->GetFloatDefault("Solocraft.FireLandsRaid", 10.0) },                          // Firelands
        ...
        diff_Multiplier_Heroics =
        {
            ...
            // CATA Instances Heroics
            {645, sConfigMgr->GetFloatDefault("Solocraft.BlackrockCavernsH", 5.0) },                      // Blackrock Caverns H
            {644, sConfigMgr->GetFloatDefault("Solocraft.HallsofOriginationH", 5.0) },                    // HallsofOrigination H
            {940, sConfigMgr->GetFloatDefault("Solocraft.HourofTwilightH", 5.0) },                        // Hour of Twilight H
